...
object InstTests {
  ...
  def getRTypeTests() : List[CPUTestCase] = {
        val rtype = List[CPUTestCase](
            CPUTestCase("add1",
                    Map("single-cycle" -> 1, "single-cycle-non-combin" -> 100, "pipelined" -> 5, "pipelined-non-combin" -> 50, "pipelined-dual-issue" -> 5),
                    Map(5 -> 1234),
  ...
  def getRTypeMultiCycleTests() : List[CPUTestCase] = {
        val rtypeMultiCycle = List[CPUTestCase](
            CPUTestCase("addfwd",
                    Map("single-cycle" -> 10, "single-cycle-non-combin" -> 1000, "pipelined" -> 14, "pipelined-non-combin" -> 140, "pipelined-dual-issue" -> 14),
                    Map(5 -> 1, 10 -> 0),
                                    Map(5 -> 1, 10 -> 10),
                                    Map(), Map()),
            CPUTestCase("swapxor",
                    Map("single-cycle" -> 3, "single-cycle-non-combin" -> 100, "pipelined" -> 7, "pipelined-non-combin" -> 70, "pipelined-dual-issue" -> 7),
                    Map(7 -> 5678, 5 -> 1234),
                                    Map(5 -> 5678,7->1234),
                                    Map(), Map()),
            CPUTestCase("power2",
            ...
            CPUTestCase("power2",
                    ...
                    Map(5 -> twoscomp(-65536), 6->1, 7->1234),
                                    ...
                                    Map(), Map(), "--65536"),
            CPUTestCase("oppsign",
                    Map("single-cycle" -> 2, "single-cycle-non-combin" -> 100, "pipelined" -> 7, "pipelined-non-combin" -> 70, "pipelined-dual-issue" -> 7),
            ...
            CPUTestCase("oppsign",
                    ...
                    Map(5 -> 512, 6->1024, 7->1234),
                                    ...
                                    Map(), Map(), "-false"),
            CPUTestCase("rotR",
                    Map("single-cycle" -> 4, "single-cycle-non-combin" -> 100, "pipelined" -> 8, "pipelined-non-combin" -> 80, "pipelined-dual-issue" -> 8),
  ...
  def getItypeMultiCycleTests() : List[CPUTestCase] = {
        val itypeMultiCycle = List[CPUTestCase](
            CPUTestCase("addi2",
                    Map("single-cycle" -> 2, "single-cycle-non-combin" -> 100, "pipelined" -> 6, "pipelined-non-combin" -> 60, "pipelined-dual-issue" -> 6),
                    Map(),
                                    Map(0 -> 0, 10 -> 17, 11 -> 93),
                                    Map(), Map())
        )
  ...
  def getBranchTests() : List[CPUTestCase] = {
        val branch = List[CPUTestCase](
            CPUTestCase("beq",
                    Map("single-cycle" -> 3, "single-cycle-non-combin" -> 100, "pipelined" -> 9, "pipelined-non-combin" -> 90, "pipelined-dual-issue" -> 9),
  ...
  def getBranchMultiCycleTests() : List[CPUTestCase] = {
        val branchMultiCycle = List[CPUTestCase](
            CPUTestCase("beqfwd1",
                    Map("single-cycle" -> 5, "single-cycle-non-combin" -> 100, "pipelined" -> 12, "pipelined-non-combin" -> 120, "pipelined-dual-issue" -> 12),
        ...
        val memory = List[CPUTestCase](
            ...
            CPUTestCase("lwu",
                    ...
                    Map(),
                                    ...
                                    Map(), Map()),
            CPUTestCase("lwu1",
                    Map("single-cycle" -> 6, "single-cycle-non-combin" -> 100, "pipelined" -> 10, "pipelined-non-combin" -> 50, "pipelined-dual-issue" -> 10),
                    Map(),
            ...
            CPUTestCase("ld2",
                    ...
                    Map(),
                                    ...
                                    Map(), Map()),
            CPUTestCase("sw",
                    Map("single-cycle" -> 6, "single-cycle-non-combin" -> 100, "pipelined" -> 10, "pipelined-non-combin" -> 100, "pipelined-dual-issue" -> 10),
                    Map(5 -> 1234),
                                    Map(6 -> 1234),
                                    Map(), Map(0x100 -> 1234)),
            CPUTestCase("sw2",
                    Map("single-cycle" -> 6, "single-cycle-non-combin" -> 100, "pipelined" -> 20, "pipelined-non-combin" -> 100, "pipelined-dual-issue" -> 20),
                    Map(5 -> twoscomp(-123)),
            ...
            CPUTestCase("sd1",
                    Map("single-cycle" -> 20, "single-cycle-non-combin" -> 1000, "pipelined" -> 30, "pipelined-non-combin" -> 100, "pipelined-dual-issue" -> 30),
                    Map(5 -> BigInt("0102030405060708", 16)),
                                    Map(6 -> BigInt("0102030405060708" , 16), 7 -> BigInt("ffffffffffffffff", 16)),
                                    Map(), Map()),
            CPUTestCase("sd2",
                    Map("single-cycle" -> 10, "single-cycle-non-combin" -> 1000, "pipelined" -> 20, "pipelined-non-combin" -> 100, "pipelined-dual-issue" -> 20),
                                    Map(5 -> 0x100),
                                    Map(6 -> 0x110),
                                    Map(), Map()),
        )
  ...
  def getMemoryMultiCycleTests() : List[CPUTestCase] = {
        val memoryMultiCycle = List[CPUTestCase](
            ...
            CPUTestCase("ldfwd",
                ...
                Map(), Map()),
            CPUTestCase("swfwd1",
                Map("single-cycle" -> 7, "single-cycle-non-combin" -> 100, "pipelined" -> 11, "pipelined-non-combin" -> 110, "pipelined-dual-issue" -> 11),
                Map(5 -> 0, 7->1234),
                Map(5 -> 1234, 6 -> 1234, 7->1234),
                Map(), Map(0x100 -> 1234)),
            CPUTestCase("swfwd2",
                Map("single-cycle" -> 8, "single-cycle-non-combin" -> 100, "pipelined" -> 12, "pipelined-non-combin" -> 120, "pipelined-dual-issue" -> 12),
                Map(5 -> 0, 7->1234),
                Map(5 -> 1234, 6 -> 1234, 7->1234),
                Map(), Map(0x100 -> 1234))
        )
  ...
  def getJumpTests() : List[CPUTestCase] = {
        val jump = List[CPUTestCase](
            CPUTestCase("jal",
                    Map("single-cycle" -> 2, "single-cycle-non-combin" -> 100, "pipelined" -> 9, "pipelined-non-combin" -> 90, "pipelined-dual-issue" -> 9),
                    Map(5 -> 1234),
  ...
  def getDualIssueTests() : List[CPUTestCase] = {
        val dualIssue = List[CPUTestCase](
            CPUTestCase("dual_addfwd1",
                    Map("single-cycle" -> 2, "single-cycle-non-combin" -> 100, "pipelined" -> 6, "pipelined-non-combin" -> 56, "pipelined-dual-issue" -> 6),
                    Map(1->10, 2->2),
                    Map(0->0, 1->14, 2->2),
                                    Map(), Map()),
            CPUTestCase("dual_addfwd2",
                    Map("single-cycle" -> 4, "single-cycle-non-combin" -> 100, "pipelined" -> 9, "pipelined-non-combin" -> 59, "pipelined-dual-issue" -> 9),
                    Map(1->2),
                                    Map(0->0, 1->32),
                                    Map(), Map()),
            CPUTestCase("dual_addfwd3",
                    Map("single-cycle" -> 6, "single-cycle-non-combin" -> 100, "pipelined" -> 11, "pipelined-non-combin" -> 61, "pipelined-dual-issue" -> 11),
                    Map(1->2),
                                    Map(0->0, 1->128),
                                    Map(), Map()),
            ...
            CPUTestCase("dual_add1",
                    Map("single-cycle" -> 2, "single-cycle-non-combin" -> 100, "pipelined" -> 6, "pipelined-non-combin" -> 56, "pipelined-dual-issue" -> 5),
  ...
  def getFullApplicationsTests() : List[CPUTestCase] = {
        val fullApplications =  List[CPUTestCase](
                CPUTestCase("multiply.riscv",
                        Map("single-cycle" -> 42342, "single-cycle-non-combin" -> 3500000, "pipelined" -> 100000, "pipelined-non-combin" -> 1000000, "pipelined-dual-issue" -> 100000),
                        Map(),
                                        Map(10->12345678),
                                        Map(), Map()),
                CPUTestCase("median.riscv",
                        Map("single-cycle" -> 9433, "single-cycle-non-combin" -> 3500000, "pipelined" -> 100000, "pipelined-non-combin" -> 1000000, "pipelined-dual-issue" -> 100000),
                        Map(),
                                        Map(10->12345678),
                                        Map(), Map()),
                CPUTestCase("qsort.riscv",
                        Map("single-cycle" -> 263290, "single-cycle-non-combin" -> 3500000, "pipelined" -> 300000, "pipelined-non-combin" -> 3000000, "pipelined-dual-issue" -> 300000),
                        Map(),
                                        Map(10->12345678),
                                        Map(), Map()),
                CPUTestCase("rsort.riscv",
                        Map("single-cycle" -> 263290, "single-cycle-non-combin" -> 3500000, "pipelined" -> 250000, "pipelined-non-combin" -> 3500000, "pipelined-dual-issue" -> 250000),
                        Map(),
                                        Map(10->12345678),
                                        Map(), Map()),
                CPUTestCase("spmv.riscv",
                        Map("single-cycle" -> 40000, "single-cycle-non-combin" -> 3500000, "pipelined" -> 50000, "pipelined-non-combin" -> 3500000, "pipelined-dual-issue" -> 50000),
                        Map(),
                                        Map(10->12345678),
                                        Map(), Map()),
                CPUTestCase("st-matmul-8.riscv",
                        Map("single-cycle" -> 5000, "single-cycle-non-combin" -> 3500000, "pipelined" -> 5000, "pipelined-non-combin" -> 3500000, "pipelined-dual-issue" -> 4000),
                        Map(),
                                        Map(10->12345678),
                                        Map(), Map()),
                CPUTestCase("st-matmul-16.riscv",
                        Map("single-cycle" -> 30000, "single-cycle-non-combin" -> 3500000, "pipelined" -> 30000, "pipelined-non-combin" -> 3500000, "pipelined-dual-issue" -> 25000),
                        Map(),
                                        Map(10->12345678),
                                        Map(), Map()),
                CPUTestCase("st-matmul-32.riscv",
                        Map("single-cycle" -> 200000, "single-cycle-non-combin" -> 3500000, "pipelined" -> 220000, "pipelined-non-combin" -> 3500000, "pipelined-dual-issue" -> 180000),
                        Map(),
                                        Map(10->12345678),
                                        Map(), Map()),
                CPUTestCase("towers.riscv",
                        Map("single-cycle" -> 12653, "single-cycle-non-combin" -> 3500000, "pipelined" -> 100000, "pipelined-non-combin" -> 1000000, "pipelined-dual-issue" -> 100000),
                        Map(),
                                        Map(10->12345678),
                                        Map(), Map()),
                CPUTestCase("vvadd.riscv",
                        Map("single-cycle" -> 5484, "single-cycle-non-combin" -> 3500000, "pipelined" -> 20000, "pipelined-non-combin" -> 2000000, "pipelined-dual-issue" -> 20000),
                        Map(),
                                        Map(10->12345678),
                                        Map(), Map()),
                CPUTestCase("stream-64-stride-1.riscv",
                        Map("single-cycle" -> 100000, "single-cycle-non-combin" -> 3500000, "pipelined" -> 500000, "pipelined-non-combin" -> 2000000, "pipelined-dual-issue" -> 20000),
                        Map(),
                                        Map(10->12345678),
                                        Map(), Map()),
                CPUTestCase("stream-64-stride-1-noverify.riscv",
                        Map("single-cycle" -> 100000, "single-cycle-non-combin" -> 3500000, "pipelined" -> 500000, "pipelined-non-combin" -> 2000000, "pipelined-dual-issue" -> 20000),
                        Map(),
                                        Map(10->12345678),
                                        Map(), Map()),
                CPUTestCase("stream-64-stride-4.riscv",
                        Map("single-cycle" -> 100000, "single-cycle-non-combin" -> 3500000, "pipelined" -> 500000, "pipelined-non-combin" -> 2000000, "pipelined-dual-issue" -> 20000),
                        Map(),
                                        Map(10->12345678),
                                        Map(), Map()),
                CPUTestCase("stream-64-stride-4-noverify.riscv",
                        Map("single-cycle" -> 100000, "single-cycle-non-combin" -> 3500000, "pipelined" -> 500000, "pipelined-non-combin" -> 2000000, "pipelined-dual-issue" -> 20000),
                        Map(),
                                        Map(10->12345678),
                                        Map(), Map()),
  ...
  def getSmallApplicationsTests() : List[CPUTestCase] = {
        val smallApplications = List[CPUTestCase](
            CPUTestCase("fibonacci",
                        Map("single-cycle" -> 300, "single-cycle-non-combin" -> 10000, "pipelined" -> 1000, "pipelined-non-combin" -> 10000, "pipelined-dual-issue" -> 1000),
                        Map(6->11),
                                        Map(6->11,5->89),
                                        Map(), Map()),
            CPUTestCase("naturalsum",
                        Map("single-cycle" -> 200, "single-cycle-non-combin" -> 10000, "pipelined" -> 500, "pipelined-non-combin" -> 5000, "pipelined-dual-issue" -> 500),
                        Map(),
                                        Map(5->55),
                                        Map(), Map()),
            CPUTestCase("multiplier",
                        Map("single-cycle" -> 1000, "single-cycle-non-combin" -> 100000, "pipelined" -> 1000, "pipelined-non-combin" -> 10000, "pipelined-dual-issue" -> 1000),
                        Map(5->23,6->20,8->0x1000),
                                        Map(5->23*20),
                                        Map(), Map()),
            CPUTestCase("divider",
                        Map("single-cycle" -> 1000, "single-cycle-non-combin" -> 100000, "pipelined" -> 2000, "pipelined-non-combin" -> 20000, "pipelined-dual-issue" -> 2000),
                        Map(5->1260,6->30),
                                        Map(7->42),
                                        Map(), Map())
        )
  ...
  def getLoopsUnrolledFullApplicationsTests() : List[CPUTestCase] = {
        val loopsUnrolledFullApplications = List[CPUTestCase](
            ...
            CPUTestCase("median-loops-unrolled.riscv",
                    Map("single-cycle" -> 9433, "single-cycle-non-combin" -> 100000, "pipelined" -> 100000, "pipelined-non-combin" -> 1000000, "pipelined-dual-issue" -> 100000),
                    Map(),
                                    Map(10->12345678),
                                    Map(), Map()),
            ...
            CPUTestCase("spmv-loops-unrolled.riscv",
                    Map("single-cycle" -> 40000, "single-cycle-non-combin" -> 3500000, "pipelined" -> 250000, "pipelined-non-combin" -> 3500000, "pipelined-dual-issue" -> 250000),
                    Map(),
                                    Map(10->12345678),
                                    Map(), Map()),
            ...
            CPUTestCase("st-matmul-16-loops-unrolled.riscv",
                    Map("single-cycle" -> 27000, "single-cycle-non-combin" -> 3500000, "pipelined" -> 30000, "pipelined-non-combin" -> 3500000, "pipelined-dual-issue" -> 24000),
                    Map(),
                                    Map(10->12345678),
                                    Map(), Map()),
            CPUTestCase("st-matmul-32-loops-unrolled.riscv",
                    Map("single-cycle" -> 196000, "single-cycle-non-combin" -> 3500000, "pipelined" -> 210000, "pipelined-non-combin" -> 3500000, "pipelined-dual-issue" -> 171000),
                    Map(),
                                    Map(10->12345678),
                                    Map(), Map()),
